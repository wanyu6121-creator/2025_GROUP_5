    ...
    , isVRRotating(false)
{
    ...
    {
        connect(ui->actionViewFront, &QAction::triggered,
                this, &MainWindow::handleViewFront);
        connect(ui->actionViewTop,   &QAction::triggered,
                this, &MainWindow::handleViewTop);
        connect(ui->actionViewRight, &QAction::triggered,
                this, &MainWindow::handleViewRight);
        connect(ui->actionViewIso,   &QAction::triggered,
                this, &MainWindow::handleViewIso);
        ...
        /* Default action: clicking the button itself applies Front view */
        viewBtn->setDefaultAction(ui->actionViewFront);
        /* Re-set text after setDefaultAction (which overwrites it) */
        viewBtn->setText("Set View");

        /* Insert before actionReset_View in the toolbar */
